    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Форма заказа</div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/order') }}">
                        ...
                        <div class="form-group{{ $errors->has('Phone') ? ' has-error' : '' }}">
                            <label for="text" class="col-md-4 control-label">Контактый телефон</label>
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fa fa-btn fa-sign-in"></i> Отправить заказ
                                </button>
                            </div>
                        </div>
                    </form>
